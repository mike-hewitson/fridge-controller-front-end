'use strict';
// var summary_fixture = require('./fixtures/history_fixture');
var summary_fixture = [{ "_id": { "date": "2016-04-26" }, "count": 288, "avgHum": 50.40173611376021, "avgTemp": 23.17361119389534, "maxTemp": 27.799999237060547, "minTemp": 9.800000190734863, "maxHum": 60.79999923706055, "minHum": 35.400001525878906 },
...
describe('Controller: SummaryChartCtrl', function() {
    ...
    beforeEach(inject(function($controller, _$httpBackend_, $rootScope, summaryFactory) {
        ...
        $httpBackend.expectGET("http://localhost:3000/summary").respond(summary_fixture);
